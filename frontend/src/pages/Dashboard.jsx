    ...
    <div className="min-h-screen p-4 md:p-6 lg:p-8" data-testid="dashboard">
      ...
      <Tabs defaultValue="control" className="space-y-6">
        ...
        <TabsContent value="control" className="space-y-6">
          {/* Stream Preview */}
          <Card className="glass gradient-border" data-testid="stream-preview">
            <div>
              <CardHeader>
              ...
              <CardContent>
                <div className="relative w-full aspect-video bg-gradient-to-br from-purple-900/40 to-pink-900/40 rounded-lg overflow-hidden border-2 border-pink-400/30">
                  {/* Video Preview Area */}
                  <div className="absolute inset-0 flex items-center justify-center">
                    {obsStats.streaming ? (
                      <div className="text-center space-y-4">
                        <div className="relative">
                          <div className="w-32 h-32 mx-auto rounded-full bg-gradient-to-br from-pink-500 to-purple-500 flex items-center justify-center animate-pulse">
                            <Video className="w-16 h-16 text-white" />
                          </div>
                          <div className="absolute inset-0 w-32 h-32 mx-auto rounded-full bg-gradient-to-br from-pink-500 to-purple-500 animate-ping opacity-20"></div>
                        </div>
                        <div>
                          <p className="text-2xl font-bold gradient-text mb-2">{obsStats.current_scene}</p>
                          <p className="text-sm text-gray-300">Broadcasting at {obsStats.fps} FPS</p>
                          <p className="text-xs text-gray-400 mt-1">{(obsStats.bitrate / 1000).toFixed(1)}k kbps</p>
                        </div>
                      </div>
                    ) : (
                      <div className="text-center space-y-4">
                        <Monitor className="w-24 h-24 mx-auto text-gray-500 opacity-50" />
                        <div>
                          <p className="text-xl font-semibold text-gray-400">Stream Offline</p>
                          <p className="text-sm text-gray-500 mt-2">Start streaming to see preview</p>
                        </div>
                      </div>
                    )}
                  </div>
                  ...
                  {obsStats.streaming && (
                    <>
                      ...
                      <div className="absolute top-4 left-4 glass px-3 py-1.5 rounded-full">
                        <p className="text-xs font-semibold text-pink-400">{obsStats.current_scene}</p>
                      </div>
                      
                      {/* Top Right - Live Indicator */}
                      <div className="absolute top-4 right-4 bg-red-500 px-3 py-1.5 rounded-full flex items-center gap-2">
                      ...
                      {obsStats.recording && (
                        <div className="absolute bottom-4 left-4 bg-red-600 px-3 py-1.5 rounded-full flex items-center gap-2">
                          <Circle className="w-3 h-3 fill-white text-white" />
                          <p className="text-xs font-bold text-white">REC</p>
                        </div>
                      )}
                      ...
                      <div className="absolute bottom-4 right-4 glass px-3 py-1.5 rounded-full flex items-center gap-2">
                        ...
                        <p className="text-xs font-bold text-white">{twitchStats.viewers}</p>
                      </div>
                    </>
                  )}
                </div>
                
                {/* Active Sources Indicators */}
